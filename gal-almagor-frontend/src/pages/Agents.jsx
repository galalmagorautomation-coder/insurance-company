...
function Agents() {
  ...
  const confirmUpdate = async () => {
    ...
    const formDataToSubmit = {
      ...
      elementary_status: updateForm.elementary_status === '' ? null : updateForm.elementary_status === 'true',
      life_insurance_license: updateForm.life_insurance_license === '' ? null : updateForm.life_insurance_license === 'true',
      elementary_license: updateForm.elementary_license === '' ? null : updateForm.elementary_license === 'true',
  ...
  if (!addForm.agent_name) {
    ...
    const formDataToSubmit = {
      ...
      insurance: hasInsuranceId,
      elementary: hasElementaryId,
      elementary_status: addForm.elementary_status === '' ? null : addForm.elementary_status === 'true',
      life_insurance_license: addForm.life_insurance_license === '' ? null : addForm.life_insurance_license === 'true',
      elementary_license: addForm.elementary_license === '' ? null : addForm.elementary_license === 'true',
      company_id: autoGeneratedCompanyIds
    }
        ...
        <div className="bg-white rounded-2xl shadow-2xl w-full max-w-5xl animate-fadeIn relative">
          ...
          <div className="p-6 max-h-[calc(100vh-280px)] overflow-y-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
              ...
              <div>
                <label className="block text-sm font-semibold text-gray-700 mb-2">
                  {t('lifeInsuranceLicense')}
                </label>
                <select
                  value={updateForm.life_insurance_license}
                  onChange={(e) => handleUpdateFormChange('life_insurance_license', e.target.value)}
              ...
              <div>
                ...
                <select
                  value={updateForm.elementary_license}
                  onChange={(e) => handleUpdateFormChange('elementary_license', e.target.value)}
                  className="w-full px-4 py-3 bg-white border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-brand-primary focus:border-brand-primary transition-all outline-none text-gray-900 font-medium"
                >
                  <option value="">{t('select')}</option>
                  <option value="true">{t('yes')}</option>
              ...
              <div>
                <label className="block text-sm font-semibold text-gray-700 mb-2">
                  <Tag className="w-4 h-4 inline mr-1" />
                  {t('subCategoriesLifeInsurance')}
                </label>
                <select
                  value={updateForm.life_insurance_sub_category}
                  onChange={(e) => handleUpdateFormChange('life_insurance_sub_category', e.target.value)}
                  className="w-full px-4 py-3 bg-white border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-brand-primary focus:border-brand-primary transition-all outline-none text-gray-900"
                >
                  <option value="">{t('selectSubCategory')}</option>
                </select>
              ...
              <div>
                ...
                <select
                  value={updateForm.elementary_status}
                  onChange={(e) => handleUpdateFormChange('elementary_status', e.target.value)}
                  className="w-full px-4 py-3 bg-white border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-brand-primary focus:border-brand-primary transition-all outline-none text-gray-900 font-medium"
                >
                  <option value="">{t('selectElementaryStatus')}</option>
              ...
              <div className="col-span-full">
                ...
                <p className="text-xs text-gray-500 mb-3 mt-1">
                  ...
                  {/* Company-specific Commission IDs — section disabled (commissions no longer tracked) */}
                  {/* <div className="col-span-full">
                    <h4 className="text-sm font-bold text-gray-700 mb-1 border-b pb-2 mt-4">
          ...
          <div className="p-6 max-h-[calc(100vh-280px)] overflow-y-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
              ...
              <div>
                ...
                <select
                  value={addForm.life_insurance_license}
                  onChange={(e) => handleAddFormChange('life_insurance_license', e.target.value)}
                  className="w-full px-4 py-3 bg-white border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-brand-primary focus:border-brand-primary transition-all outline-none text-gray-900 font-medium"
                >
                  <option value="">{t('select')}</option>
                  <option value="true">{t('yes')}</option>
              ...
              <div>
                ...
                <select
                  value={addForm.elementary_license}
                  onChange={(e) => handleAddFormChange('elementary_license', e.target.value)}
                  className="w-full px-4 py-3 bg-white border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-brand-primary focus:border-brand-primary transition-all outline-none text-gray-900 font-medium"
                >
                  <option value="">{t('select')}</option>
                  <option value="true">{t('yes')}</option>
              ...
              <div>
                ...
                <select
                  value={addForm.life_insurance_sub_category}
                  onChange={(e) => handleAddFormChange('life_insurance_sub_category', e.target.value)}
                  className="w-full px-4 py-3 bg-white border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-brand-primary focus:border-brand-primary transition-all outline-none text-gray-900"
                >
                  <option value="">{t('selectSubCategory')}</option>
                </select>
              ...
              <div>
                ...
                <select
                  value={addForm.elementary_status}
                  onChange={(e) => handleAddFormChange('elementary_status', e.target.value)}
                  className="w-full px-4 py-3 bg-white border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-brand-primary focus:border-brand-primary transition-all outline-none text-gray-900 font-medium"
                >
                  <option value="">{t('selectElementaryStatus')}</option>
                  <option value="true">{t('active')}</option>
