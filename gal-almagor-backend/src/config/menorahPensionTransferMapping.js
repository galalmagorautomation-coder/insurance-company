 ...
 * - Row 2+: Agent data
 *   - Column AC "מספר סוכן": Agent number
 *   - Column AL "סכום העברה - ניוד נטו": Net pension transfer amount (output)
 *
...
const MENORAH_PENSION_TRANSFER_MAPPING = {
  ...
  columns: {
    agentNumber: 'מספר סוכן',               // Column AC - Agent Number
    output: 'סכום העברה - ניוד נטו',        // Column AL - Net pension transfer amount
  },
